...
class SlidingWindowDiffusionPolicy(BaseImagePolicy):
    ...
    #     print(f"loss_b: {loss_b.shape}, values: {loss_b}")
    #     """
    #     loss_b: torch.Size([32]), values: tensor([2.7671, 2.7425, 2.8643, 2.5782, 2.9360, 2.8933, 2.8221, 2.8397, 2.7439,
    #     2.7020, 2.7885, 2.9949, 2.9724, 2.7563, 2.7658, 2.7072, 2.6820, 2.7837,
    #     2.8350, 2.7473, 2.7451, 2.6205, 2.8931, 2.6848, 2.8202, 2.9161, 2.6466,
    #     2.9882, 2.8006, 2.8240, 2.8416, 2.7631], device='cuda:0',
